...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdNames, int iCmdShow) {
	...
	MSG msg;
	TCHAR szClassName[] = TEXT("IDI_WARNING_DEMO");
	HWND hwnd;
	...
	wndClassEx.hIconSm = LoadIcon(NULL, IDI_WARNING);
	...
	hwnd = CreateWindow(szClassName, TEXT("IDI_WARNING"), WS_OVERLAPPEDWINDOW, 100, 100, 800, 600, NULL, NULL, hInstance, 0);
