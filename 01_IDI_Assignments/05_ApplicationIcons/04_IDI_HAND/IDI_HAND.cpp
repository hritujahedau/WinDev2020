...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdNames, int iCmdShow) {
	...
	MSG msg;
	TCHAR szClassName[] = TEXT("IDI_HAND");
	HWND hwnd;
	...
	wndClassEx.hIcon = LoadIcon(NULL, IDI_HAND);
	...
	hwnd = CreateWindow(szClassName, TEXT("IDI_HAND"), WS_OVERLAPPEDWINDOW, 100, 100, 800, 600, NULL, NULL, hInstance, 0);
